...
class BasesDecodeTest(unittest.TestCase):
    ...
    def test_decode_decimal_values(self):
        assert decode("10.10", 2) == 2.5
        assert decode(".10", 2) == 0.5
        assert decode("000000.10", 2) == 0.5
        assert decode("1010.11", 2) == 10.75
        assert decode("11.14", 8) == 9.1875
        assert decode("71.7", 8) == 57.875
        assert decode("221223233.32", 8) == 38086299.40625
        assert decode("10.1", 16) == 16.0625
        assert decode("11.3", 16) == 17.1875
        assert decode("1A.A", 16) == 26.625
        assert decode("AA1A.F", 16) == 43546.9375
        assert decode("3MCD1O.A3MGA3MGA3MGA", 25) == 38086299.40625
